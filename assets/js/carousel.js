class Carousel {
  constructor(p) {
    ...
    this.slidesItem = this.container.querySelectorAll(settings.slideID);
  ...
  _initProps() {
    this.currentSlide = 0;
    this.SLIDES_COUNT = this.slidesItem.length;
  ...
  _initIndicators() {
    ...
    this.indicator = this.container.querySelectorAll(".indicator");
  }
  ...
  _gotoNumber(n) {
    this.slidesItem[this.currentSlide].classList.toggle("active");
  ...
  _gotoPrev() {
    this._gotoNumber(this.currentSlide - 1);
  }
  ...
  _indicate(e) {
    ...
    if (target.classList.contains("indicator")) {
      this._pause();
      this._gotoNumber(+target.dataset.slideTo);
    }
  }
